...
if(isset($_REQUEST['post_id']) && !isset($_REQUEST['job_id'])){
    ...
    $cus_job_id = 'JOB-SPACES-'.str_pad($cus_job_id, 4, "1000", STR_PAD_LEFT);
}
...
//    }
        ...
        $err_msg = "CFT loaded can not be greater than current space available. You can add maximum $current_space_available c.f";
    }
                                ...
                                <div class="registration_main">
                                    <div class="open_post_bg ">
                                            ...
                                            <span class="ecs_tooltip">Press Esc to close <span class="arrow"></span></span>
                                                <form action="" method="POST" name="add_career_form" id="add_career_form">
                                                   <div class="open_post_bg_in pp2">
                                                    ...
                                                    <p><label>Company Phone:<strong style="color: red;">*</strong></label><input autocomplete="off" maxlength="14" name="company_phone" id="company_phone" type="text" class="post_loads_txtfld phone_format" value="<?php if(isset($company_phone)){ echo $company_phone;}?>"></p>
                                                    ...
                                                    <p><label>Phone:<strong style="color: red;">*</strong></label><input autocomplete="off" maxlength="14" id="phone" name="phone"  type="text" class="post_loads_txtfld phone_format" value="<?php if(isset($phone)){ echo $phone;}?>"></p>
                                        ...
                                        <div class="post_loads_div">
                                            ...
                                            <p><label>Carrier/MOVING:</label><input name="carrier_name" id="carrier_name" type="text" readonly class="post_loads_txtfld" value="<?php if(isset($carrier_name)){echo $carrier_name;}?>"></p>
                                            ...
                                            <p><label>Driver/Disp Phone #:</label><input name="dispatcher_phone" id="dispatcher_phone" autocomplete="off" maxlength="15" value="<?php if(isset($dispatcher_phone)){echo format_phone($dispatcher_phone);}?>" type="text" class="post_loads_txtfld"></p>                                            
                                            ...
                                            <p><label>Cust Phone #:</label><input name="cus_phone" id="cus_phone" autocomplete="off" maxlength="15" value="<?php if(isset($cus_phone)){echo format_phone($cus_phone);}?>" type="text" class="post_loads_txtfld"></p>
